...
class Dashboard_instructor extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div className="boxes flex space-x-24 relative -top-[1%] -left-[10%] mx-auto">
          ...
          <Link to="/instructor/grades" className="bg-custom-image4 box flex items-center justify-center shadow-md w-[280px] h-[180px] bg-slate-800 cursor-pointer rounded-[15px] transition ease duration-300 hover:bg-[rgb(51,65,85)]">
