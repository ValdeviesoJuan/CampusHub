  ...
  return (
    <header className="bg-slate-900	 text-white py-4 z-40 h-20">
      <div className="container mx-auto px-4 flex items-center h-20">
        ...
        <Link to="/student/dashboard" className="text-white text-2xl font-bold transition ease-in-out duration-300 hover:text-slate-500 relative left-2 top-[-18%] ">CampusHub</Link>
